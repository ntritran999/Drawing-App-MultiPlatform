...
class _ShapesSection extends StatelessWidget {
	...
	static const List<_ShapeItem> _items = [
		...
		_ShapeItem(type: ShapeType.square, label: 'Square', icon: Icons.crop_square),
		_ShapeItem(type: ShapeType.circle, label: 'Circle', icon: Icons.radio_button_unchecked),
		_ShapeItem(type: ShapeType.ellipse, label: 'Ellipse', icon: IconData(0x2B2D, fontFamily: "MaterialIcons")),
	];
		...
		return Column(
			...
			children: [
				...
				SwitchListTile.adaptive(
					...
					title: const Text('Fill shape', style: TextStyle(color: Colors.white)),
							...
							children: [
								ListTile(
									...
									onTap: () {
										...
										ScaffoldMessenger.of(context).showSnackBar(
											const SnackBar(content: Text('PNG export layout is ready.')),
										);
									},
								),
								ListTile(
									...
									onTap: () {
										Navigator.of(context).pop();
										ScaffoldMessenger.of(context).showSnackBar(
											const SnackBar(content: Text('JPEG export layout is ready.')),
										);
									},
								),
							],
